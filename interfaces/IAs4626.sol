...
interface IAs4626 is IERC20Metadata, IAsRescuable, IAsManageable {
    ...
    function safeMint(uint256 _shares, uint256 _maxAmount, address _receiver) external returns (uint256);
    function safeDeposit(uint256 _amount, uint256 _minShareAmount, address _receiver) external returns (uint256);
    ...
    function safeWithdraw(uint256 _amount, uint256 _minAmount, address _receiver, address _owner)
        external
        returns (uint256);
    function safeRedeem(uint256 _shares, uint256 _minAmountOut, address _receiver, address _owner)
        external
        returns (uint256);
    ...
    // ERC-7540
    function requestRedeem(uint256 _shares, address _operator, address _owner, bytes calldata _data)
        external
        returns (uint256);
    function requestWithdraw(uint256 _amount, address _operator, address _owner, bytes calldata _data)
        external
        returns (uint256);
